...
- Otimizei ao máximo para a aplicação fazer a menor quantidade de requisições à API possível
- Utilizei o pré-processsador SCSS
- Usei axios para controlar chamadas API
- Criei rotas home e cart, com header estático, utilizando vue-router
- Formatei todos os preços para padrão R$
- localStorage dos produtos, para não consultar a API mais do que o necessário 
